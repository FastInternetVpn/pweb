...
exit;
  ...
  echo -e 'by: @fastinternetvpn' >/usr/lib/telegram
  echo -e "\e[1;97m           \e[5m\033[1;100m   INSTALADOR Painel FAST INTERNET VPN ⚡   \033[1;37m"
...
echo -e "\033[1;33m MAIS INFORMAÇÕES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@fastinternetvpn\033[0m"
echo ""
